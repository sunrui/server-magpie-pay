package com.project.spider.core.spider.fordeal.web.crawler4j;
...
public class ForDealCrawlerFetchProvider {
...
//		config.setHaltOnError(true);
	...
	public static void main(String[] args) {
		ForDealCrawlerFetchProvider forDealCrawlerFetchProvider = new ForDealCrawlerFetchProvider();
		try {
			forDealCrawlerFetchProvider.test();
		} catch (Exception e) {
			e.printStackTrace();
		}
	}
