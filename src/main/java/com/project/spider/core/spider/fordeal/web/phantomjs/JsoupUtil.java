...
public class JsoupUtil {
    ...
    static {
        ...
        dcaps.setCapability(PhantomJSDriverService.PHANTOMJS_EXECUTABLE_PATH_PROPERTY, "/Users/sunrui/Documents/develop/spider/phantomjs");
    }
    ...
    public static Elements checkResult(Elements elements, String url, String targetEx) {
        if(elements == null || !StringUtils.hasText(elements.html())) {
